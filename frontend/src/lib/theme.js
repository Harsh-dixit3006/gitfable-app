...
export const accent = {
  ...
  textSoft:     'text-amber-300/70',
  textGhost:    'text-amber-100/35',
  textBright:   'text-amber-300',
  bg:           'bg-amber-400/10',
  bgSoft:       'bg-amber-400/6',
  bgSubtle:     'bg-amber-300/10',
  bgFaint:      'bg-amber-300/5',
  border:       'border-amber-400/25',
  borderSoft:   'border-amber-400/15',
  ...
  badgeMuted:   'bg-amber-400/6 border border-amber-400/25',
  bookmarkHover:'hover:text-amber-200 hover:bg-amber-300/5 hover:border-amber-300/20',
